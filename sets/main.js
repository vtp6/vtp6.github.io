...
function check_input() {
  ...
  if (userans === "backdoorallow" && wrong.length > 0) {
...
function draw_sub() {
  ...
  sub2.innerHTML = `<el>© Rujul Nayak 2023-` + ("" + new Date().getFullYear()).slice(-2) + `</el> ` +
